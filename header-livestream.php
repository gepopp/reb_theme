...
<header class="header container mx-auto p-0">
    <div class="flex justify-between w-full">
        <div class="logo-holder">
            <a href="<?php echo home_url() ?>">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/real-estate-brand-institute_logo.svg" class="w-24 py-4"/>
            </a>
        </div>
        <div class="py-4">
